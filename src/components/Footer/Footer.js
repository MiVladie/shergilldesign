	...
	return (
		<footer className={classes.Footer}>
			<div className={classes.Main}>
				<div className={classes.About}>
					...
					<p className={classes.Description}>
						We have been investing in buy-to-let properties over 20 years if you are interested in
						buy-to-let investment! We have our team of builders to carry out on any projects.
					</p>
				</div>
			...
			<p className={classes.Extra}>
				Copyright Shergill Design &copy;{new Date().getFullYear()} All rights reserved
			</p>
			<p className={classes.Extra}>
				Website created by{' '}
